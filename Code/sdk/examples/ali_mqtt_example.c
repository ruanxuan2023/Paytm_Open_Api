...
#define DEMO_PRODUCT_KEY   "XXXX"
#define DEMO_DEVICE_NAME   "XXXXXXXXXXX"
#define DEMO_DEVICE_SECRET "XXXXXXXXXXXXXXXXXXXXX"
...
static int mqtt_connect(void)
{
     ...
     */
    mqtt_params.host = DEMO_PRODUCT_KEY".iot-as-mqtt.cn-shanghai.aliyuncs.com"; 
...
static void prvAliMqttExampleThread(void *param){
    activeNetwork();
    mqtt_connect();
    osiThreadExit();
}
...
int appimg_enter(void *param)
{
    ...
    osiThreadCreate("tcp_example", prvAliMqttExampleThread, NULL, 18, 10*1024);
    return 0;
}
