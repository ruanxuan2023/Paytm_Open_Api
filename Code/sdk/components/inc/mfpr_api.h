...
/**
 * @brief initialize mfpr with default parameters.
 */
void mfp_init(void);

/**
 * @brief initialize mfpr with parameters.
 * 
 * @param mfp_cfgs  mfgr configs
 */
void mfp_config(const unsigned int  *mfp_cfgs);

/**
 * @brief read mfpr configs by offser.
 * 
 * @param mfpr_offset  offset from base to mfgr config targets
 */
int mfp_dump(unsigned int mfpr_offset);

/**
 * @brief read mfpr configs by grp.
 * 
 * @param mfp_cfgs  target to get mfgr configs
 */
int mfp_dump_grp(const unsigned int * mfp_cfgs);

#ifdef CONFIG_CIS_ENABLE
void CIS_MfpConfig(const unsigned int *mfp_cfg);
#endif/*CONFIG_CIS_ENABLE*/
#ifdef __cplusplus
}
#endif // __cplusplus
