...
static inline int lwip_get_lte_dlpath_switch(void)
{
    return lwip_system_ctrl.lte_DLpath_enable;
}

static inline int lwip_get_lte_ulpath_switch(void)
{
    return lwip_system_ctrl.lte_ULpath_enable;
}
...
int lwip_get_nw_status(const char* hostname);
int lwip_get_nw_status_ip6(const char* hostname);
...
u8_t  lwip_get_iot_test_mode(void);
...
int lwip_select_netif_ipv4_ready(char *netifname, u32_t mstimeout);
int lwip_select_netif_ipv6_ready(char *netifname, u32_t mstimeout);
