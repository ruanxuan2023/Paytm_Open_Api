...
void ledRun(void)
{
    ...
    Paytm_Set_Battery_Led(0, 1, 0);Paytm_TRACE(">>>>Battery led 1 twinkle");
    Paytm_delayMilliSeconds(8000);   Paytm_Set_Battery_Led(0, 0, 1);
    Paytm_Set_Battery_Led(1, 1, 1);Paytm_TRACE(">>>>Battery led 2 twinkle");
    Paytm_delayMilliSeconds(8000);  Paytm_Set_Battery_Led(1, 0, 1);
    Paytm_Set_Battery_Led(2, 1, 2);Paytm_TRACE(">>>>Battery led 3 twinkle");
    Paytm_delayMilliSeconds(8000);  Paytm_Set_Battery_Led(2, 0, 1);
