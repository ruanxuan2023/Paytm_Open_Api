...
#define PAYTM_CHARGE_LED_PIN_1  (54)
#define PAYTM_CHARGE_LED_PIN_2  (55)
#define PAYTM_CHARGE_LED_PIN_3  (37)
#define PAYTM_CHARGE_LED_PIN_4  (73)

#define PAYTM_LED_RED_PINMUX     (GPIO_02)
#define PAYTM_LED_GREEN_PINMUX   (GPIO_74)
#define PAYTM_LED_BLUE_PINMUX    (GPIO_53)
#define PAYTM_CHARGE_LED_PINMUX_1   (GPIO_54)
#define PAYTM_CHARGE_LED_PINMUX_2   (GPIO_55)
#define PAYTM_CHARGE_LED_PINMUX_3   (GPIO_37)
#define PAYTM_CHARGE_LED_PINMUX_4   (GPIO_73)
...
#define PAYTM_CHARGE_LED_4_FUN  (MFP_AF0)
